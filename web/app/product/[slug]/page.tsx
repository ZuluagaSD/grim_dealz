...
export async function generateMetadata({
  ...
  // OG image auto-generated by Next.js from opengraph-image.tsx (dynamic, edge-rendered)
  // No need to specify images here — Next.js injects them from the convention file
