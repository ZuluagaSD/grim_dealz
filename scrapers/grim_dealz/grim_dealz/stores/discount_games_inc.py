...
# Product page fetches: 10 concurrent, 0.2 s polite delay per slot
_CONCURRENCY = 10
_PRODUCT_SLEEP = 0.2
# Category pagination: 3 categories scraped concurrently; 0.2 s between page fetches per category
_CAT_CONCURRENCY = 3
_PAGE_SLEEP = 0.2
_BATCH_SIZE = 50
...
def _parse_product_page(html: str, url: str) -> PriceResult | None:
    ...
    product_name: str | None = (name_tag.get("content") or "").strip() or None if name_tag else None
